...
homer = RandomParticipant.new(oracle, max_num_attempts: NUM_OF_RUNS*2)
...
total_num_attempts = 0
total_num_failures = 0
bart = LinearParticipant.new(oracle, max_num_attempts:NUM_OF_RUNS*2)
1.upto(NUM_OF_RUNS) do |i|
  oracle.secret_number = i
  bart.reset
  if bart.play(1)==:success
...
total_num_attempts = 0
total_num_failures = 0
maggie = SmartRandomParticipant.new(oracle, max_num_attempts:NUM_OF_RUNS*5)
1.upto(NUM_OF_RUNS) do |i|
  oracle.secret_number = i
  maggie.reset
...
total_num_attempts = 0
total_num_failures = 0
lisa = BinarySearchParticipant.new(oracle, max_num_attempts:NUM_OF_RUNS*5)
1.upto(NUM_OF_RUNS) do |i|
  oracle.secret_number = i
  lisa.reset
